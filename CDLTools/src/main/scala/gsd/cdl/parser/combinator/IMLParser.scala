...
//          println("Begin processing: " + id)
          ...
          val defVal = opts.typeFilter[DefaultOption].firstOption
          val calc = opts.typeFilter[CalculatedOption].firstOption
          ...
          val legalValues = opts.typeFilter[LegalValuesOption].firstOption
//          println(legalValues)
